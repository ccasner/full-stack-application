...
var config = {
  apiOrigins: {
    production: 'https://protected-hollows-11558.herokuapp.com'
  },
  googleMaps: {
    production: 'https://maps.googleapis.com/maps/api/js?key=AIzaSyA_pEqp7-EjtsC3ilVbHmMEiJkft3H07bg'
  }
  // &callback=initMap
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<tr data-id=\""
    ...
    + "</td>\n  <td><button class='add-button'>Add Charge</button>\n</tr>\n\n";
  ...
  return "<tr data-id=\""
    ...
    + "</td>\n  <td><button class='remove-button'>Remove</button></td>\n  <td><button class='edit-button'>Edit Date</button></td>\n</tr>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=depth0 != null ? depth0 : (container.nullContext || {});

  return ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.tolls : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n"
    ...
    + "\n\n\n\n  <!-- <li class='dynamic'><button class='add-button'>Add</button></li> -->\n";
...
var onGetCharges = function onGetCharges() {
  $('#charge-content').show();
  api.getCharges().then(ui.getChargesSuccess).catch(ui.failure);
};
var onClearCharges = function onClearCharges() {
  $('#charge-content').hide();
...
var onGetOneToll = function onGetOneToll() {
  var tollId = store.tollId;
  api.getOneToll(tollId).then(ui.getOneTollSuccess).catch(ui.failure);
};
var onUpdateCharge = function onUpdateCharge(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  var id = chargeId;
  api.updateCharge(id, data).then(ui.updateChargeSuccess).catch(ui.failure);
};

var getChargeId = function getChargeId(deleteButton) {
  var elementId = $(deleteButton).parent().parent().attr('data-id');
  return elementId;
};

var onDeleteCharge = function onDeleteCharge(event) {
  event.preventDefault();
  $('#edit-date').hide();
  var deleteButton = event.target;
  var data = getChargeId(deleteButton);
  api.deleteCharge(data).then(function () {
    ui.deleteChargeSuccess(deleteButton);
  }).catch(ui.failure);
};
var chargeId = '';

var allowEdit = function allowEdit(event) {
  event.preventDefault();
...
module.exports = {
  addHandlers: addHandlers, // being required by index.js
  onGetOneToll: onGetOneToll // being required by tolls/ui.js
...
var addCharge = function addCharge(location, price, date) {
  return $.ajax({
...
var updateCharge = function updateCharge(id, data) {
  return $.ajax({
...
var deleteCharge = function deleteCharge(data) {
  return $.ajax({
...
var getCharges = function getCharges() {
  return $.ajax({
    url: config.apiOrigin + '/charges',
    method: 'GET',
    headers: {
...
var getOneToll = function getOneToll(data) {
  return $.ajax({
...
var tollEvents = __webpack_require__(19);
var chargeEvents = __webpack_require__(9);
...
var onGetTolls = function onGetTolls() {
  api.getTolls().then(ui.getTollsSuccess).catch(ui.failure);
};

module.exports = {
  onGetTolls: onGetTolls
};
...
var getTolls = function getTolls() {
  return $.ajax({
    url: config.apiOrigin + '/tolls',
    method: 'GET'
  });
};
var getOneToll = function getOneToll() {
  return $.ajax({
...
var showTolls = __webpack_require__(7);
var chargeEvents = __webpack_require__(9);
var store = __webpack_require__(2);

var getTollId = function getTollId(event) {
  event.preventDefault();
  var elementId = $(this).parent().parent().attr('data-id');
  store.tollId = elementId;
};

var getTollsSuccess = function getTollsSuccess(data) {
  store.tolls = data.tolls;
  var showTollsHtml = showTolls({ tolls: data.tolls });
...
module.exports = {
  getTollsSuccess: getTollsSuccess,
  failure: failure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var store = __webpack_require__(2);
var api = __webpack_require__(10);
var showCharges = __webpack_require__(7);

var addChargeSuccess = function addChargeSuccess() {
  $('#message2').text('Charge Added, set date!').show();
  $('#message2').delay(1000).fadeOut('slow');
  $('#edit-date').hide();
  api.getCharges().then(getChargesSuccess).catch(failure);
};
var getOneTollSuccess = function getOneTollSuccess(data) {
  var onAddCharge = function onAddCharge(data) {
    var location = data.toll.location;
    var price = data.toll.price;
    var date = '0000-00-00';
    api.addCharge(location, price, date).then(addChargeSuccess).catch(failure);
  };
  onAddCharge(data);
};

var deleteChargeSuccess = function deleteChargeSuccess(deleteButton) {
  $('#message2').text('Charge Deleted').show();
  $('#message2').delay(1000).fadeOut('slow');
  $(deleteButton).parent().parent().remove();
};

var updateChargeSuccess = function updateChargeSuccess() {
...
var getChargesSuccess = function getChargesSuccess(data) {
  store.charges = data.charges;
  var showChargesHtml = showCharges({ charges: data.charges });
  $('.charge-content').html(showChargesHtml);
  $('#getChargesButton').hide();
  $('#hideChargesButton').show();
  $('.add-button').show();
};
var hideChargesSuccess = function hideChargesSuccess() {
  $('#hideChargesButton').hide();
  $('#getChargesButton').show();
};
...
module.exports = {
  addChargeSuccess: addChargeSuccess,
  getChargesSuccess: getChargesSuccess,
  getOneTollSuccess: getOneTollSuccess,
  updateChargeSuccess: updateChargeSuccess,
  deleteChargeSuccess: deleteChargeSuccess,
  hideChargesSuccess: hideChargesSuccess,
  failure: failure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
